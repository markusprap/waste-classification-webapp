...
// Flag to track if Midtrans is available
let midtransAvailable = false;

export const isMidtransAvailable = () => midtransAvailable;
...
export const initMidtrans = () => {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (!clientKey) {
      // Don't throw error, just log warning and resolve
      console.warn('NEXT_PUBLIC_MIDTRANS_CLIENT_KEY not configured - payment features disabled');
      midtransAvailable = false;
